#!/usr/bin/env bash
# Download the Marjum DEM files (15 TIFs + 1 XML metadata) into the package
...
DEST="$(cd "$(dirname "$0")/.." && pwd)/src/eigsep_terrain/data"
mkdir -p "$DEST"
...
QUADS=(9145 9146 9147 9245 9246 9247 9345 9346 9347 9445 9446 9447 9545 9546 9547)
